...
def search():
    ...
    return render_template('search.html', books=books, page=page, per_page=per_page, total_books=total_books, query=query, mode=mode, sort=sort, min_pages=min_pages, max_pages=max_pages)
...
def edit_book():
    ...
    return render_template('edit_book.html', book=book_to_edit, list_books_for=list_books_for)
...
def delete_book():
    ...
    return render_template('delete_book.html', books=list_books_for, book=book_to_delete)
